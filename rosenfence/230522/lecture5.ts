...
//이거랑 같음
function foo2(x: number | undefined): number {
  return x + 5;
}
...
function counter(e: number | string): number {
...
function canMarry(money: number, house: boolean, face: string): string | void {
  let sum: number;
